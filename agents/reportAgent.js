...
export async function generateReport(role, level, techStack, history, interviewType = "technical") {
...
Generate a detailed report in this exact JSON format (no markdown, no code blocks):
{
  ...
  "recommendations": "1-2 sentences of advice for the candidate"${isBehavioral ? `,
  "starScorecard": {
    "situation": 8,
    "task": 8,
    "action": 7,
    "result": 9,
    "feedback": "a 1-2 sentence overall evaluation of their STAR structured delivery"
  }` : ""}
}
`;
